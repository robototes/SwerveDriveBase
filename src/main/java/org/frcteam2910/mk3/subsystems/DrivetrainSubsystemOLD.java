...
public class DrivetrainSubsystemOLD implements Subsystem, UpdateManager.Updatable  {
    ...
    public DrivetrainSubsystemOLD() {
       ...
       backRightDriveMotor.setInverted(true);
        ...
        moduleAngleEntries = new GenericEntry[modules.length];
    ...
    private final GenericEntry driveSpeedToggle;
